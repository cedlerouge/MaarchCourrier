...
class AttachmentController
{
    ...
    public function update(Request $request, Response $response, array $args)
    {
        ...
        && (!PrivilegeController::hasPrivilege(['privilegeId' => 'update_attachments', 'userId' => $GLOBALS['id']]) || !PrivilegeController::hasPrivilege(['privilegeId' => 'update_delete_attachments', 'userId' => $GLOBALS['id']])) 
